# 2. Write a program to implement propositional logic in AI.
# Code by Bhavy Kharbanda
# Sap Id:- 500082531
# Propositional Logics include, Conjunction, Disjunction, Negation, Implication and Biconditional Operations.
import numpy as np
